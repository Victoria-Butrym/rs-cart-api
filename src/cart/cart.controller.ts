import { Controller, Get, Delete, Put, Body, Req, Post, UseGuards, HttpStatus, Param, Inject } from '@nestjs/common';
...
export class CartController {
  ...
  async findAllCarts() {
    ...
    return {
      ...
      message: 'findAllCarts',
      data: { carts }
    }
  }

  @Get(':id')
  findCardById(@Param() params: any) {

    return {
      statusCode: HttpStatus.OK,
      message: 'findCardById',
      data: { params }
    }
  }
